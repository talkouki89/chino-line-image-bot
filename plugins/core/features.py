...
FEATURE_DEFINITIONS = [
    ...
    },
    {
        "key": "engine_ehentai",
        "name": "E-Hentai",
        "description": "E-Hentai 圖片搜尋。",
        "commands": "回覆搜4",
    },
    {
        "key": "engine_exhentai",
        "name": "ExHentai",
        "description": "ExHentai 圖片搜尋，需要 Cookie。",
        "commands": "回覆搜5",
    },
    {
        "key": "engine_copyseeker",
        "name": "Copyseeker",
        "description": "Copyseeker 圖片搜尋。",
        "commands": "回覆搜6",
    },
    {
        "key": "engine_yandex",
    ...
    },
    {
        "key": "xslist",
        "name": "XSList",
        "description": "XSList 女優資料搜尋。網站有 Cloudflare，可能需要 Cookie。",
        "commands": "xs:關鍵字",
    },
    {
        "key": "media_tools",
